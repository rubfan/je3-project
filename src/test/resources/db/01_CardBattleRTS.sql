...
ALTER TABLE `Card_Product` ADD CONSTRAINT `Card_Product_fk2` FOREIGN KEY (`p1_set_building_id`) REFERENCES `Card_Building`(`set_id`);
ALTER TABLE `Card_Product` ADD CONSTRAINT `Card_Product_fk3` FOREIGN KEY (`p2_set_building_id`) REFERENCES `Card_Building`(`set_id`);
ALTER TABLE `Card_Product` ADD CONSTRAINT `Card_Product_fk4` FOREIGN KEY (`p1_set_resource_id`) REFERENCES `Card_Resource`(`set_id`);
